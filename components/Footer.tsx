            ...
            <ul className="space-y-3">
              {navLinks.map(({ href, label }) => (
                <li key={href}>
                  <Link
                    href={href}
                    className="text-sm text-white/40 hover:text-gold transition-colors duration-200 tracking-wide"
                  >
                    {label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-start gap-3 text-sm text-white/40 hover:text-gold transition-colors duration-200 group"
              >
